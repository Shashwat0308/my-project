                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                            {featuredProducts.map((product, index) => (
                                <motion.div
                                    ...
                                    transition={{ delay: index * 0.1 }}
                                    whileHover={{ y: -10 }}
                                    className="rounded-3xl overflow-hidden shadow-xl border border-gray-200 hover:shadow-2xl transition-all"
                                >
                                    ...
                                    <div className="p-6 bg-white">
                                        ...
                                        <p className="text-xl font-semibold text-purple-600">₹{product.price}</p>
                                    </div>
                                </motion.div>
                            ))}
                        </div>
